...
const AddRequestSummary = ({onReviewClick,addOrderToAnotherList,deleteOrderById ,product}) => {
  ...
  const [productDetails, setProductDetails] = useState({
    ...
    category: '',
    description: '',
    features: ['', '', '', ''], // Example for multiple features
  });
              ...
              <div style={ProductDetailsStyles.container}>
                  ...
                  />
                    ...
                    <TextBoxField 
                      ...
                      placeholder={product.daysprice?.days14 ?? "empty"} 
                  />
                     <TextBoxField 
                      label="سعر المنتج لـ7 أيام" 
                      placeholder={product.daysprice?.days7 ?? "empty"}  
                  />
                     <TextBoxField 
                      label="سعر المنتج لـ5 أيام" 
                      placeholder={product.daysprice?.days5 ?? "empty"} 
                  />
