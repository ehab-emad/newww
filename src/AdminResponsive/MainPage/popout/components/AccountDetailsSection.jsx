...
const AccountDetailsSection = ({member}) => {
  return (
    <div className={styles.accountDetails}>
      ...
      <div className={styles.detailsGrid}>
        ...
        <div className={styles.detailField}>
          ...
          <div className={styles.fieldValue}>{member.lastname || 'empty'}</div>
        </div>
        ...
        <div className={styles.detailField}>
          ...
          <div className={styles.fieldValue}>{member.name  || 'empty'}</div>
        </div>
        ...
        <div className={styles.detailField}>
          <div className={styles.fieldLabel}>
            ...
            {member.isNumberVerified && (
                <span className={styles.verifiedBadge}>تم التحقق</span>
            )}
          </div>
          <div className={styles.fieldValue}>{member.phone ||'empty'}</div>
        </div>
        ...
        <div className={styles.detailField}>
          ...
          <div className={styles.fieldValue}>{member.email}</div>
        </div>
