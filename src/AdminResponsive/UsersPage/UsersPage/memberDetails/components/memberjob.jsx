  ...
  return (
    <div className={styles.membershipSection}>
      <div className={styles.sectionHeader}>
        <div className={styles.headerTitle}>نوع الوظيفه</div>
        <img
          loading="lazy"
      ...
      <div className={styles.membershipTypes}>
        ...
        {/* {membershipTypes.map((type, index) => ( */}
          ...
          >
            <div className={styles.badgeTitle}>{member.role}</div>
...
export default MemberjobSection;